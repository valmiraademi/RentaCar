...
<div id="main">
    <div id="slide-bar">
        ...
        <?php                
            if(isset($_GET['automjetiid'])) {
                echo '<h1>Modifikimi i automjetit</h1>';   
            } else {             
                echo '<h1>Shtimi i automjetit</h1>';         
            } 
        ?> 
        </div>
    </div>
        ...
        <?php                
            if(isset($_GET['automjetiid'])) {
                echo '<h1 id="hi">Forma per modifikimin e automjetit</h1>';   
            } else {             
                echo '<h1 id="hi">Forma per shtimin e automjetit</h1>';         
            } 
        ?>
